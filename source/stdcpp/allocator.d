...
import stdcpp.new_;
import stdcpp.xutility : StdNamespace, __cpp_sized_deallocation, __cpp_aligned_new;
...
extern(D):
    ...
    {
        import stdcpp.xutility : _MSC_VER;
        ...
        T* allocate(size_t count) @nogc
        {
            ...
            {
                import stdcpp.xutility : _Xbad_alloc;
                if (count == 0)
                    return null;
                void* mem;
...
version (CppRuntime_Microsoft)
{
    ...
    {
        import stdcpp.xutility : __CXXLIB__;
...
version (CppRuntime_Clang)
{
    ...
    package(stdcpp) void __swap_allocator(Alloc)(ref Alloc __a1, ref Alloc __a2)
    {
