...
// I think we can have these here now, since the project have been moved from druntime
...
//            _My_data._Check_offset(_Off);
    ...
    private:
        import stdcpp.xutility : MSVCLinkDirectives;
        import stdcpp.xutility : _Container_base;
...
//                        __throw_length_error(__N("basic_string::_S_create"));
                ...
                {
                    import stdcpp.xutility : __exchange_and_add_dispatch;
...
//                            _GLIBCXX_SYNCHRONIZATION_HAPPENS_AFTER(&this._M_refcount);
                ...
                {
                    import stdcpp.xutility : __atomic_add_dispatch;
...
//                                                __s, __pos, this->size());
        ...
        {
			//commented out because __cxx11::basic_string seem to work fine
...
version (CppRuntime_Microsoft)
{
    import stdcpp.xutility : _ITERATOR_DEBUG_LEVEL;
...
extern(C++, (StdNamespace)):
    ...
    extern(D) @safe @nogc:
        ...
        static if (_ITERATOR_DEBUG_LEVEL > 0)
        {
            import stdcpp.xutility : _Container_proxy;
